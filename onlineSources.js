...
var mapUrl = {
     ...
     */
    "tian-img": "http://t{0-7}.tianditu.com/DataServer?T=img_w&x={x}&y={y}&l={z}",
    "tian-roadLabel": "http://t{0-7}.tianditu.com/DataServer?T=cia_w&x={x}&y={y}&l={z}",
    "tian-label": "http://t{0-7}.tianditu.com/DataServer?T=cva_w&x={x}&y={y}&l={z}",
    "tian-vec": "http://t{0-7}.tianditu.com/DataServer?T=vec_w&x={x}&y={y}&l={z}",
    "tian-ter": "http://t{0-7}.tianditu.com/DataServer?T=ter_w&x={x}&y={y}&l={z}",
    /***
     *geoq地图
...
//pbs: http://192.168.1.110:7080/PBS/rest/services/QGVEC/MapServer/WMTS/tile/1.0.0/QGVEC/default/GoogleMapsCompatible/{z}/{y}/{x}.png
/***
 * 高德地图、天地图、百度地图、geoq
 */
/*******************************在线地图onlineMap*************************************/
...
ol.inherits(ol.source.onlineMap, ol.source.XYZ);
